...
def mobilenetv2(pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        a = torch.load('./mobilenetv2best-model-parameters.pt')

        a['classifier.1.weight'] = a['classifier.weight']
        del a['classifier.weight']
        a['classifier.1.bias'] = a['classifier.bias']
        del a['classifier.bias']
